...
parameters.icn.syne.max_integration_interval = 1/20;
parameters.icn.syne.integration_tau = -0.01;
parameters.icn.syne.gain = 0.7e-9;
parameters.icn.Eth = -56.2e-3;
parameters.icn.syni.integration_tau = -0.1;
parameters.icn.syni.max_integration_interval = 1/40;
...
figure_handle.Name = 'Rose-Lemmon NSF 2024 GA 20 pulses VDC';
...
function [afferent, relay, spd, lin, icn] = propagate(times, triggers, afferent, relay, spd, lin, icn)
    ...
    icn = icn.propagate(times, relay.trigs, [lin.trigs], 0);
end