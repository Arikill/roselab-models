...
disp("Afferent");
afferent = {};
afferent.neuron = Neuron(14e-12, 0.5e9, -65e-3, -30e-3, -100e-3, -55e-3, -20e-3, 0.02, -20e-3, -60e-3);
...
disp("Relay");
relayNeuron = {};
relayNeuron.neuron = Neuron(14e-12, 0.5e9, -65e-3, -30e-3, -100e-3, -55e-3, -20e-3, 0.02, -20e-3, -60e-3);
...
disp("LIN");
lin = {};
lin.neuron = Neuron(14e-12, 0.5e9, -65e-3, -30e-3, -100e-3, -57e-3, -20e-3, 0.03, -20e-3, -60e-3);
lin.excitatorySynapse = Synapse(1e-9, 0.03);
lin.excitation = lin.excitatorySynapse.call(trigs, s.fs, 1/30, 0.03, 0.035);
lin.nmdaSynapse = Synapse(0.5e-9, 0.05);
lin.nmdaExcitation = lin.nmdaSynapse.call(trigs, s.fs, 1/30, 0.04, 0.035);
...
disp("ICN");
icn = {};
icn.neuron = Neuron(14e-12, 0.5e9, -65e-3, -30e-3, -100e-3, -57e-3, -20e-3, 0.03, -20e-3, -60e-3);
icn.excitatorySynapse = Synapse(0.6e-9, 0.02);
icn.excitation = icn.excitatorySynapse.call(trigs, s.fs, 1/30, 0.1, 0.055);
icn.nmdaSynapse = Synapse(0.5e-9, 0.05);
icn.nmdaExcitation = lin.nmdaSynapse.call(trigs, s.fs, 1/30, 0.04, 0.055);
icn.inhibitorySynapse = Synapse(1e-9, 0.015);
icn.inhibition = icn.inhibitorySynapse.call(lin.spkTrigs, s.fs, 1/30, -0.05, 0.01);
[icn.response, icn.spkTrigs] = icn.neuron.call(0e-9, icn.excitation, icn.inhibition, s.fs, icn.nmdaExcitation);

disp("ICN: 2nd Order");
icn2 = {};
icn2.neuron = Neuron(14e-12, 0.5e9, -65e-3, -30e-3, -100e-3, -57e-3, -20e-3, 0.03, -20e-3, -60e-3);
...
ylabel('ICN response');
ax(4) = nexttile;
plot(times, icn.excitation, 'r', times, icn.inhibition, 'b', times, icn.nmdaExcitation, '--r');
ylabel('ICN conductances');
ax(5) = nexttile;
plot(times, lin.response, 'k');
ylabel('LIN response');
ax(6) = nexttile;
plot(times, lin.excitation, 'r', times, lin.inhibition, 'b', times, lin.nmdaExcitation, '--r');
